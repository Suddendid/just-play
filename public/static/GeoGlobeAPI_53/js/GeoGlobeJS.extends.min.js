...
if(c.classList.contains("title-icons-close")){if(d)for(var a=f[e],g=0;g<a.length;g++)b.map.showLayer(a[g].id);else b.map.showLayer(e);c.classList.remove("title-icons-close");c.classList.add("title-icons-open")}else{if(d){a=f[e];for(g=0;g<a.length;g++)b.map.hideLayer(a[g].id)}else b.map.hideLayer(e);c.classList.remove("title-icons-open");c.classList.add("title-icons-close")}}if(c.getAttribute("layerControl")==="editZindex"){for(var h=c.getAttribute("edit"),a=c.parentNode;a.getAttribute("layerControl")!=
...
"GeoGlobe-layer-opacity");b.innerHTML='<input type="range" min="1" max="100" step="1" layerControl="layer-opacity" /><span class="layer-opacity-close" layerControl="layer-opacity-close"></span>';f.appendChild(b);b=document.createElement("div");b.classList.add("GeoGlobe-layer-items");c="";for(var a=this.controlLayers,e=Object.keys(a),d=e.length-1;d>=0;d--){var g=a[e[d]],h=!1;GeoGlobe.Util.isArray(g)&&(h=!0);var i='<span class="layer-edit-icons icons-opacity" layerControl="editOpacity" title="\u900f\u660e\u5ea6"></span>';
if(h){for(var j=!1;0<g.lengrh;d++)if(g[0].type!="symbol"){j=!0;break}j||(i="")}g=this._subString(e[d],15);c+='<div class="GeoGlobe-layer-item" layercontrol="GeoGlobe-layer-item" layerid='+e[d]+" isVTS="+h+'><div class="GeoGlobe-layer-content"><div class="layer-title"><span class="title-icons title-icons-open" layercontrol="layerShow"></span><span class="layer-name" title='+e[d]+">"+g+'</span></div><div class="layer-edit"><span class="layer-edit-icons icons-top" layerControl="editZindex" edit="top" title="\u7f6e\u9876"></span><span class="layer-edit-icons icons-up" layerControl="editZindex" edit="up" title="\u4e0a\u79fb"></span><span class="layer-edit-icons icons-down" layerControl="editZindex" edit="down" title="\u4e0b\u79fb"></span><span class="layer-edit-icons icons-bottom" layerControl="editZindex" edit="bottom" title="\u7f6e\u5e95"></span>'+
...
b[f].getAttribute("layerid");c==="LEV13-14/\u4ea4\u901a\u7ebf/D\u96a7\u9053\u4e2d\u5fc3\u7ebf/label/Class"&&this.map.getLayer(c);var c=this.map.getLayoutProperty(c,"visibility"),a=b[f].firstElementChild.firstElementChild;c!="none"?a.classList.add("title-icons-open"):a.classList.add("title-icons-close")}},_ctrSubLayerIcon:function(b,f){for(var c=0;c<b.length;c++)f?(b[c].firstElementChild.firstElementChild.classList.add("title-icons-open"),b[c].firstElementChild.firstElementChild.classList.remove("title-icons-close")):
(b[c].firstElementChild.firstElementChild.classList.remove("title-icons-open"),b[c].firstElementChild.firstElementChild.classList.add("title-icons-close"))},_ctrLayersIcon:function(b){for(var f=!0,c=0;c<b.length;c++)if(b[c].firstElementChild.firstElementChild.classList.contains("title-icons-open")){f=!0;break}else f=!1;b=b[0].parentNode.previousElementSibling.firstElementChild.children[1];f?(b.classList.add("title-icons-open"),b.classList.remove("title-icons-close")):(b.classList.remove("title-icons-open"),
b.classList.add("title-icons-close"))},_nextNode:function(b){if(!b.nextSibling)return!1;return b.nextElementSibling||(b.nextSibling.nodeType==1?b.nextSibling:nextNode(b.nextSibling))},_previousNode:function(b){if(!b.previousSibling)return!1;return b.previousElementSibling||(b.previousSibling.nodeType==1?b.previousSibling:previousNode(b.previousSibling))},_initDom:function(){var b=this.controlLayers;this._ctrLayerShowBtn();for(var f=document.querySelectorAll("li[layerControl='GeoGlobe-vtslayer-item']"),
c=0;c<f.length;c++){for(var a=f[c].getAttribute("sourceid"),a=b[a],e=!1,d=0;d<a.length;d++)if(this.map.getLayoutProperty(a[d].id,"visibility")==="visible"){e=!0;break}e?f[c].firstElementChild.firstElementChild.classList.add("title-icons-open"):f[c].firstElementChild.firstElementChild.classList.add("title-icons-close");a=f[c].lastElementChild.children;this._ctrSubLayerShowBtn(a);this._initSubColorBtn(a);this._initSubLayerIcon(a)}},_createDom:function(){var b=this.options,f=document.createElement("div");
...
h=!1,i=0;i<g.length;i++)if(g[i].type!="symbol"){h=!0;break}g="";h&&(g='<span class="vtslayer-edit-icons icons-opacity" layerControl="editOpacity" title="\u900f\u660e\u5ea6"></span>');c+='<li class="GeoGlobe-vtslayer-item" layerControl="GeoGlobe-vtslayer-item" sourceid="'+a[e]+'"><div class="GeoGlobe-vtslayer-content"><div class="vtslayer-title"><span class="toggle-icons" layerControl="GeoGlobe-vtslayer-toggle"></span><span class="title-icons title-icons-open" layercontrol="layerShow"></span><span class="layer-name" title="'+
a[e]+'">'+d+'</span></div><div class="vtslayer-edit"><span class="vtslayer-edit-icons icons-top" edit="top" layerControl="editZindex" title="\u7f6e\u9876"></span><span class="vtslayer-edit-icons icons-up" edit="up" layerControl="editZindex" title="\u4e0a\u79fb"></span><span class="vtslayer-edit-icons icons-down" edit="down" layerControl="editZindex" title="\u4e0b\u79fb"></span><span class="vtslayer-edit-icons icons-bottom" edit="bottom" layerControl="editZindex" title="\u7f6e\u5e95"></span>'+g+"</div></div>"+
this._createSubDom(a[e])+"</li>"}b.innerHTML=c;f.appendChild(b);this.createDom=f;document.body.appendChild(f)},_createSubDom:function(b){for(var f=this.controlLayers[b],c=["line","fill","circle"],a='<ul class="vtslayer-list">',e=f.length-1;e>=0;e--){var d=f[e].id,g=this._subString(d,12),h=f[e].type,i="";c.indexOf(h)>-1&&(i='<input type="color" class="vtslayer-edit-icons" layerControl="editColor"/>');var j='<span class="vtslayer-edit-icons icons-opacity" layerControl="editSubOpacity" title="\u900f\u660e\u5ea6"></span>';
h==="symbol"&&(j="");a+='<li class="list-layer" layerControl="list-layer" sourceid="'+b+'" layerid="'+d+'"><div class="vtslayer-title"><span class="title-icons" layercontrol="subLayerShow"></span><span class="layer-name" title="'+d+'">'+g+'</span></div><div class="vtslayer-edit"><span class="vtslayer-edit-icons icons-top" edit="top" layerControl="editSubZindex" title="\u7f6e\u9876"></span><span class="vtslayer-edit-icons icons-up" edit="up" layerControl="editSubZindex" title="\u4e0a\u79fb"></span><span class="vtslayer-edit-icons icons-down" edit="down" layerControl="editSubZindex" title="\u4e0b\u79fb"></span><span class="vtslayer-edit-icons icons-bottom" edit="bottom" layerControl="editSubZindex" title="\u7f6e\u5e95"></span>'+
j+i+"</div></li>"}a+="</ul>";return a},_subString:function(b,f){var c=0,a="",e=/[^\x00-\xff]/g,d="",g=b.replace(e,"**").length;if(g>f){for(var h=0;h<g;h++){d=b.charAt(h).toString();d.match(e)!=null?c+=2:c++;if(c>f)break;a+=d}g>f&&(a+="...")}else a=b;return a},_bindEvent:function(){var b=this,f=this.controlLayers;this._clickEvent=function(c){c=c||window.event;c=c.target||c.srcElement;c.getAttribute("layerControl")==="GeoGlobe-vtslayer-close"&&b.destroy();if(c.getAttribute("layerControl")==="GeoGlobe-vtslayer-toggle")c.classList.contains("toggle-icons-open")?
(c.classList.remove("toggle-icons-open"),c.parentNode.parentNode.nextElementSibling.style.display="none"):(c.classList.add("toggle-icons-open"),c.parentNode.parentNode.nextElementSibling.style.display="block");if(c.getAttribute("layerControl")==="layerShow"){for(var a=c.parentNode;a.getAttribute("layerControl")!="GeoGlobe-vtslayer-item";)a=a.parentNode;var e=a.lastElementChild.children,d=a.getAttribute("sourceid"),a=f[d];if(c.classList.contains("title-icons-close")){for(d=0;d<a.length;d++)b.map.showLayer(a[d].id);
c.classList.remove("title-icons-close");c.classList.add("title-icons-open");b._ctrSubLayerIcon(e,!0)}else{for(d=0;d<a.length;d++)b.map.hideLayer(a[d].id);c.classList.remove("title-icons-open");c.classList.add("title-icons-close");b._ctrSubLayerIcon(e,!1)}}if(c.getAttribute("layerControl")==="subLayerShow"){for(a=c.parentNode;a.getAttribute("layerControl")!="list-layer";)a=a.parentNode;d=a.getAttribute("layerid");c.classList.contains("title-icons-close")?(b.map.showLayer(d),c.classList.remove("title-icons-close"),
c.classList.add("title-icons-open")):(b.map.hideLayer(d),c.classList.remove("title-icons-open"),c.classList.add("title-icons-close"));b._ctrLayersIcon(c.parentNode.parentNode.parentNode.children)}if(c.getAttribute("layerControl")==="editZindex"){for(var g=c.getAttribute("edit"),a=c.parentNode;a.getAttribute("layerControl")!="GeoGlobe-vtslayer-item";)a=a.parentNode;var e=a.parentNode,d=a.getAttribute("sourceid"),h=f[d],i=h[0].id;switch(g){case "top":d=e.children[0].getAttribute("sourceid");d=f[d];g=d[d.length-
